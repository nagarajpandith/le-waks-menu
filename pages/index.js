...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className='my-5 text-center text-gray-500 dark:text-white'>Welcome to Le Wak&apos;s</div>
      <Listbox value={selectedLang} onChange={setSelectedLang}>
        <div className="my-6 relative">
          <Listbox.Button className="relative w-full cursor-default rounded-3xl bg-white py-3 pl-8 pr-10 text-left shadow-lg focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm dark:bg-gray-200">
            <span className="dark:text-black text-black block truncate">{selectedLang.name}</span>
